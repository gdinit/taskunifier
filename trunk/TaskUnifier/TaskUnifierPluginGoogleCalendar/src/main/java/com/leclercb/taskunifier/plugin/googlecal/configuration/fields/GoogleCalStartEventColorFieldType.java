...
public class GoogleCalStartEventColorFieldType extends ConfigurationFieldType.ComboBox {
	
	public GoogleCalStartEventColorFieldType() {
		super(
				getColors(),
		...
		this.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent evt) {
				ColorDefinition color = (ColorDefinition) GoogleCalStartEventColorFieldType.this.getFieldValue();
				GoogleCalStartEventColorFieldType.this.setBackground(Color.decode(color.getBackground()));
				GoogleCalStartEventColorFieldType.this.setForeground(Color.decode(color.getForeground()));
			}
