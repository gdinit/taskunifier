...
final class CallGetDeletedFolders extends AbstractCallDeleted {

    public ModelBean[] getDeletedFolders(String accessToken, Calendar deletedAfter)
        ...
        return this.getResponseMessage(ModelType.FOLDER, content);
    }
