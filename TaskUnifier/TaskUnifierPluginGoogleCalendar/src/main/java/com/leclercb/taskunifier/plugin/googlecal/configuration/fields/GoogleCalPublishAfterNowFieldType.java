...
public class GoogleCalPublishAfterNowFieldType extends ConfigurationFieldType.ComboBox {
	
	public GoogleCalPublishAfterNowFieldType() {
		super(
				getValues(),
	...
	private static Integer[] getValues() {
		return new Integer[] { 7, 15, 30, 60, 90 };
	}
