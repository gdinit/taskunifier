...
public class CalendarViewConfig {
	...
	private DateFormat monthDateFormat = new SimpleDateFormat(
			"EEEE",
			LocaleBroker.getLocale());
	// formater for week view
	private DateFormat weekDateFormat = new SimpleDateFormat(
			"EE - dd.MM",
			LocaleBroker.getLocale());
	// formater for day view
	private DateFormat dayFormat = new SimpleDateFormat(
			"EEEE dd.MM.yyyy",
			LocaleBroker.getLocale());
	// formater for day view
	...
	/**
	 * @param monthDateFormat
	 *            the monthDateFormat to set
	 */
	...
	/**
	 * @param weekDateFormat
	 *            the weekDateFormat to set
	 */
