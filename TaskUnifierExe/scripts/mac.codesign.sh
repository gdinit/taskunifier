...
then
	...
	find $APPFILE/Contents/ -type f \( -name "*.jar" -or -name "*.dylib" -or -name "*.jdk" \) -exec codesign --verbose -f -s "3rd Party Mac Developer Application: Benjamin Leclerc" --entitlements $BASEDIR/scripts/mac/entitlements.plist {} \;
